...
- [ ] Does this PR add or edit a stateful reusable workflow? If yes, does it fast-forward to the caller's target branch before selecting or writing repo state, while keeping host skeletons free of boilerplate `target_ref` wiring (WF-3)?
